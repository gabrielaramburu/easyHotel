...
EasyHotel es un software desarrollado con la idea de brindar soluciones en la gestión de pequeños y medianos hoteles.
...
No es necesario adjudicar una habitación determinada al momento de realizar una reserva, esto le da la libertad de poder seleccionar la  habitación en el momento que el cliente se haga presente en el hotel. 
...
*Control de gastos pagos ![](Aspose.Words.24cccf74-fd5b-4741-93ee-509815281bae.014.png)![](Aspose.Words.24cccf74-fd5b-4741-93ee-509815281bae.015.jpeg)*
...
*Facturación contado o crédito ![](Aspose.Words.24cccf74-fd5b-4741-93ee-509815281bae.023.png)![](Aspose.Words.24cccf74-fd5b-4741-93ee-509815281bae.024.png)*
...
Independientemente del tipo de documento con el que se le hallan  facturado los gastos, se muestra el total del saldo convertido en ambas monedas.
...
*Consulta completa estado y situación de habitaciones ![](Aspose.Words.24cccf74-fd5b-4741-93ee-509815281bae.044.png)*
...
El sistema se puede operar utilizando el mouse y el teclado.  
...
Además cada operación relevante que se realiza en el sistema se registra en la base datos, de esta manera usted tiene un total conocimiento de cómo se utiliza su sistema.
...
2. Sistema de control de operaciones realizadas (Bitácora)

Con esta aplicación podrá saber que opciones se ejecutan en su sistema, conociendo información como: fecha de ejecución, hora de inicio, hora de fin, usuario que la ejecuto, etc.

` `Cada vez que se ejecuta una operación en el sistema, de forma automática y totalmente imperceptible para el usuario, el sistema guarda información relevante de la operación ejecutada. Esta información puede ser manejada con posterioridad con la ayuda de la aplicación Bitácora.

*Crear informes ![](Aspose.Words.24cccf74-fd5b-4741-93ee-509815281bae.076.png)![](Aspose.Words.24cccf74-fd5b-4741-93ee-509815281bae.077.jpeg)*

Realizando 4 sencillos pasos, podrá crear nuevos informes con las  características que considere necesario. 

Entre las más importantes se encuentran la posibilidad de seleccionar  operaciones por: 

- nombre de usuario 
- tipo de operación 
- fecha de realizada la misma 

Además podrá determinar los campos que desea incluir en el informe, el orden de presentación de los mismos y porque criterio desea ordenar la información.

*Determinar informe predeterminado ![](Aspose.Words.24cccf74-fd5b-4741-93ee-509815281bae.078.png)*

Esta opción le da la facilidad de que luego de creado un informe y  establecido el mismo como predeterminado, al ejecutar la aplicación  bitácora, el mismo se ejecuta automáticamente disponiendo de la  información al instante. 

*Imprimir información ![](Aspose.Words.24cccf74-fd5b-4741-93ee-509815281bae.079.png)*

Además de verlos por pantalla, podrá imprimir todos los informes que realice. ![](Aspose.Words.24cccf74-fd5b-4741-93ee-509815281bae.002.png)

*Explorador de listados ![](Aspose.Words.24cccf74-fd5b-4741-93ee-509815281bae.080.png)![](Aspose.Words.24cccf74-fd5b-4741-93ee-509815281bae.081.png)*

El explorador de listados le permite trabajar con los listados existentes de una forma práctica; podrá: ejecutar listados, establecer listado  predeterminado, eliminar listados existentes, entre otras cosas. ![](Aspose.Words.24cccf74-fd5b-4741-93ee-509815281bae.002.png)

5. **Preguntas más frecuentes.![](Aspose.Words.24cccf74-fd5b-4741-93ee-509815281bae.002.png)**



|**¿Para hoteles de cuantas habitaciones esta pensado el sistema?**|
| - |
|<p>Aunque no existe un límite fijo determinado, hay que destacar que el rendimiento de algunas funciones del sistema (especialmente consultas como cuadro de disponibilidad y cuadro de situación) esta ligado directamente a la cantidad de habitaciones, a mayor cantidad de habitaciones aumenta el tiempo de procesamiento de la información, lo que se ve afectado en el rendimiento del sistema. </p><p>Aunque existen otras variables como por ejemplo, la capacidad de procesamiento del equipo, la velocidad del disco duro, la cantidad terminales que acceden al sistema (configuración multiusuario), las cuales inciden en el rendimiento de la aplicación, se garantiza que el sistema puede ser configurado hasta un máximo de 100 habitaciones aproximadamente, cantidad que puede variar según variables descriptas anteriormente.</p><p>En líneas generales podemos decir que el buen rendimiento del sistema fue una de los objetivos trazados desde la etapa de diseño del mismo, por lo que esperamos se adapte sin problemas a las exigencias de su negocio.</p>|
|<p>**¿Qué equipo se necesita para ejecutarlo?**</p><p>Se requiere como mínimo un equipo Pentiun III 166 Mhz 32Mb de memoria RAM y disco de 10 Gb o superior. Además es necesario contar con una impresora para la impresión de informes y documentos.</p><p>La misma puede ser de tipo matriz de punto, chorro de tinta o laser.</p>|
|<p>**¿Qué requisitos previos requiere un usuario  para operar el mismo?**</p><p>Para operar el sistema se requiere ser usuario PC y conocer Windows 98 o superior.</p><p>Es necesario además que el usuario esté familiarizado con los procesos y términos que se utilizan en un hotel convencional .</p>|
|**¿Cuánto tiempo se requiere para capacitar al personal en el uso del sistema?** Asumiendo que la persona a capacitar conoce la operativa de un hotel, el tiempo de capacitación se estima en 6 horas. En este tiempo el usuario está en condiciones de poder operar el sistema, profundizando en el conocimiento del mismo a media que acumula horas de trabajo con él.|
|<p>**¿Puedo restringir el uso del sistema  solo a determinadas personas?**</p><p>Si. Instalada la aplicación Perfiles, el administrador tiene total control de la personas que trabajan con el sistema, pudiendo definir incluso, perfiles para cada usuario, lo que le permitirá determinar las operaciones que puede realizar cada usuario autorizado luego de ingresar al sistema.</p>|
|<p>**¿Al instalar el sistema, pierdo toda la información de mi actual aplicación?**</p><p>Es necesario estudiar cada caso por separado, pero existe serias posibilidades de que usted pueda alimentar la base de datos del nuevo sistema con datos almacenados con otras aplicaciones. Por ejemplo si usted actualmente trabaja con una planilla Excel o maneja una base de datos Access para llevar un histórico de clientes tendrá muchas posibilidades de pasar esa información a la base de datos EasyHotel.</p>|
|**¿Cuántos usuarios pueden trabajar con el sistema a la vez?**|
|<p>El máximo de terminales esta limitado por el rendimiento de la aplicación, el cual disminuye a medida que se adicionan nodos a la red.</p><p>El sistema fue probado  con  3 terminales, conectadas mediante la plataforma Windows. </p>|
|<p>**¿Es posible realizar modificaciones al sistema luego de instalado?**</p><p>Si. El sistema esta pensado para crecer al ritmo de su empresa, adaptándolo a los nuevos requerimientos que surjan, en un tiempo corto y a bajo precio.</p>|
6. **Comuníquese con nosotros![](Aspose.Words.24cccf74-fd5b-4741-93ee-509815281bae.002.png)**

Si desea conocer la aplicación más a fondo, contáctese con nosotros para concretar una entrevista, donde con mucho gusto le haremos una demostración del producto en su hotel.
...
![funcionesFacturacionDiscriminadaportipoDeGastos](https://user-images.githubusercontent.com/63823685/186299537-278ced65-f88b-454d-82cb-ae5c2c4ef027.jpg)
