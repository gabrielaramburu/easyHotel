VERSION 5.00
Begin VB.Form frmAcercaDeBitacora 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Acerca de Bitacora"
   ClientHeight    =   4710
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6855
   Icon            =   "frmAcercaDeBitacora.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4710
   ...
   Begin VB.Label Label6 
      AutoSize        =   -1  'True
      Caption         =   "Sistema de control de operaciones realizadas"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.Image Image2 
      ...
      Height          =   2985
      Left            =   120
      Picture         =   "frmAcercaDeBitacora.frx":000C
      Top             =   120
      Width           =   1260
   End
   ...
   Begin VB.Image Image1 
      Height          =   105
      Left            =   120
      Picture         =   "frmAcercaDeBitacora.frx":B71E
      Stretch         =   -1  'True
      Top             =   3120
      Width           =   6570
   End
   ...
   End
End
Attribute VB_Name = "frmAcercaDeBitacora"
