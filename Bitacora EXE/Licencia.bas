...
Private Const cNomArchivoId As String = "bitacora.id.txt"  'nombre del archivo donde se encuentra el
                                                        'Id de la aplicación
...
Public Sub subMuestroAvisoVersionDemo()
    ...
    avisoDemo.AvisoVersionDemoPropNomAplicacion = "Bitacora"
...
Private Sub subMuestroAvisoFinEvaluacion()
    ...
    avisoFin.AvisoFinPeriodoDemoPropNomAplicacion = "EasyHotel"
