...
Exit Sub
error:
    mSubControloErroresPropiedades "mSubValidoNum"
End Sub

Public Sub mSubEliminoFilaGrilla(g As MSFlexGrid)
    'Elimino una fila de una grilla
    On Error GoTo error
...
Exit Sub
error:
    mSubControloErroresPropiedades "mSubEliminoFilaGrilla"
End Sub
